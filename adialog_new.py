...
# I wondered about calling wozGUI from within adialog, but didn't have much luck
...
#proxies are set down below
# proxies
Move = None
memory = None
asr = None

#autoMoves = ALProxy("ALAutonomousMoves","138.110.235.192",9559)
#autoMoves.setExpressiveListeningEnabled(False)
#print "Expressive Listening: ", autoMoves.getExpressiveListeningEnabled()
...
class TestModule(ALModule):
	def __init__(self, name):
		...
		print "TestModule has been activated"
		global memory
	...
	def onInput(self, name, value):
		print "have gotten inside onInput"
...
# main method
# why is robot_ip a parameter??? It's already in adialog...
...
def main(): 
	...
	#csvf = 'testApril20.csv'#april20? Why?
	filepath = "/home/nao/programs/move.top"
	initialize(robotIP, 9559, filepath, csvf)
